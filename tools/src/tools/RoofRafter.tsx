  ...
  return (
    <section className="space-y-4">
      ...
      <p className="text-sm text-slate-600">
        Enter any two of span/half-span/rise/pitch/common (plus optional overhang). The rest will
        calculate.
      </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <label className="block">
              ...
              <input
                value={commonStr}
                onChange={(e) => {
                  setCommonStr(e.target.value);
                  setLastEdited('common');
                }}
                className="mt-1 w-full rounded-md border px-2 py-1.5 text-sm"
                type="number"
              />
            ...
            <label className="block">
              ...
              <input
                value={overhangStr}
                onChange={(e) => {
                  setOverhangStr(e.target.value);
                  setLastEdited('overhang');
                }}
                className="mt-1 w-full rounded-md border px-2 py-1.5 text-sm"
                type="number"
              />
          ...
          <details className="mt-3">
            ...
            <div className="mt-2 grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <label className="block">
                ...
                <input
                  value={ridgeStr}
                  onChange={(e) => setRidgeStr(e.target.value)}
                  className="mt-1 w-full rounded-md border px-2 py-1.5 text-sm"
                  type="number"
                />
              </label>
              <label className="block">
                ...
                <input
                  value={seatStr}
                  onChange={(e) => setSeatStr(e.target.value)}
                  className="mt-1 w-full rounded-md border px-2 py-1.5 text-sm"
                  type="number"
                />
              </label>
              ...
              <label className="flex items-center gap-2 sm:col-span-2">
                <input
                  type="checkbox"
                  checked={includeOverhangArea}
                  onChange={(e) => setIncludeOverhangArea(e.target.checked)}
                />
              ...
              <div className="sm:col-span-2 grid grid-cols-2 gap-3">
                <label className="block">
                  ...
                  <input
                    value={sheetWm}
                    onChange={(e) => setSheetWm(e.target.value)}
                    className="mt-1 w-full rounded-md border px-2 py-1.5 text-sm"
                    type="number"
                    step="0.1"
                  />
                ...
                <label className="block">
                  ...
                  <input
                    value={sheetHm}
                    onChange={(e) => setSheetHm(e.target.value)}
                    className="mt-1 w-full rounded-md border px-2 py-1.5 text-sm"
                    type="number"
                    step="0.1"
                  />
            ...
            <>
              ...
              <div className="bg-white rounded-md border p-3 mt-3">
                ...
                <p className="text-xs text-slate-500 mt-2">
                  Note: Costs include sheet/cladding, underlay, linear flashings (gutters/fascia,
                  ridge, barge) and labour. Update prices in Settings to suit your project.
                  Additional items like fixings, penetrations, and waste factors are not included.
                </p>
              </div>
            </>
          )}
